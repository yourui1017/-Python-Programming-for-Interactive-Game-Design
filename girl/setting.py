...
player_down_image = pygame.image.load(os.path.join("images/girl/girl2.png")).convert()
player_down_image = pygame.transform.scale(player_down_image, (50,50))
player_down_image.set_colorkey(BLACK)

player_down_1_image = pygame.image.load(os.path.join("images/boy/boy1.png")).convert()
